...
class GridOption:
	def __init__(self, dataset_pathname, options):
		...
		if sys.platform != 'win32':
			...
			# example for windows    os.path.join(dirname, r'..'C:\Program Files\gnuplot\bin\gnuplot.exe')
			...
			self.gnuplot_pathname = os.path.join(dirname, r'..C:\Program Files\gnuplot\bin\gnuplot.exe')
		self.fold = 5
