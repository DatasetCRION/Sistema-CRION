		...
		link : function(scope, elem, attrs) {
			elem.on('keydown', function(e) {
				...
				if ((keycode > 47 && keycode < 58)
					...
					return true;
					// Tab / Delete / Backspace / Left arrow / Right arrow
				} else if ((keycode == 9) || (keycode == 46) || (keycode == 8)
    ...
    .directive('sidebarPrimaryToggle', [
        ...
        function ($rootScope, $window, $timeout) {
            return {
                ...
                replace: true,
                scope: true,
                template: '<a id="sSwitch_primary" href="#" class="sSwitch sSwitch_left" ng-click="togglePrimarySidebar($event)" ng-hide="miniSidebarActive || topMenuActive"><i class="material-icons md-36 toggle-sidebar">&#xE5D2;</i></a>',
